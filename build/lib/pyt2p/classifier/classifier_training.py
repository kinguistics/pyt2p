...
def crossval_classifier(
    alignments, window_size=WINDOW_SIZE, nfolds=10, max_depth=MAX_DEPTH
):
...
def test_classifier_depth(
    ...
    for depth in range(26, 30):
        ...
        accuracies = cross_val_score(clf, features_enc, targets_int, cv=10, n_jobs=-1)
